...
-define(benchmarks_pb_gpb_version, "4.10.2").
...
-record('AtomicRegisterRequest',
        {read_workload = 0.0    :: float() | integer() | infinity | '-infinity' | nan | undefined, % = 1
         write_workload = 0.0   :: float() | integer() | infinity | '-infinity' | nan | undefined, % = 2
         partition_size = 0     :: non_neg_integer() | undefined, % = 3, 32 bits
         number_of_keys = 0     :: non_neg_integer() | undefined % = 4, 32 bits
        }).
-endif.
