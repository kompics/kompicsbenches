...
-type 'PingPongRequest'() ::
      #{number_of_messages      => non_neg_integer() % = 1, 32 bits
       }.

-type 'ThroughputPingPongRequest'() ::
      #{messages_per_pair       => non_neg_integer(), % = 1, 32 bits
        pipeline_size           => non_neg_integer(), % = 2, 32 bits
        parallelism             => non_neg_integer(), % = 3, 32 bits
        static_only             => boolean() | 0 | 1 % = 4
       }.

-type 'AtomicRegisterRequest'() ::
      #{read_workload           => float() | integer() | infinity | '-infinity' | nan, % = 1
        write_workload          => float() | integer() | infinity | '-infinity' | nan, % = 2
        partition_size          => non_neg_integer(), % = 3, 32 bits
        number_of_keys          => non_neg_integer() % = 4, 32 bits
       }.

-type 'StreamingWindowsRequest'() ::
      #{number_of_partitions    => non_neg_integer(), % = 1, 32 bits
        batch_size              => non_neg_integer(), % = 2, 32 bits
        window_size             => iodata(),        % = 3
        number_of_windows       => non_neg_integer(), % = 4, 32 bits
        window_size_amplification => non_neg_integer() % = 5, 32 bits
       }.
...
-type 'TestSuccess'() ::
      #{number_of_runs          => non_neg_integer(), % = 1, 32 bits
        run_results             => [float() | integer() | infinity | '-infinity' | nan] % = 2
       }.
...
-export_type(['PingPongRequest'/0, 'ThroughputPingPongRequest'/0, 'AtomicRegisterRequest'/0, 'StreamingWindowsRequest'/0, 'TestResult'/0, 'TestSuccess'/0, 'TestFailure'/0, 'NotImplemented'/0, 'ReadyRequest'/0, 'ReadyResponse'/0, 'ShutdownRequest'/0, 'ShutdownAck'/0]).

-spec encode_msg('PingPongRequest'() | 'ThroughputPingPongRequest'() | 'AtomicRegisterRequest'() | 'StreamingWindowsRequest'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) ->
    encode_msg(Msg, MsgName, []).

-spec encode_msg('PingPongRequest'() | 'ThroughputPingPongRequest'() | 'AtomicRegisterRequest'() | 'StreamingWindowsRequest'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'(), atom(), list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  encode_msg_StreamingWindowsRequest(id(Msg, TrUserData),
					     TrUserData);
      'TestResult' ->
...
encode_msg_ThroughputPingPongRequest(#{} = M, Bin,
				     TrUserData) ->
    B1 = case M of
...
encode_msg_AtomicRegisterRequest(#{} = M, Bin,
				 TrUserData) ->
    B1 = case M of
	   #{read_workload := F1} ->
	       begin
...
encode_msg_StreamingWindowsRequest(Msg, TrUserData) ->
    encode_msg_StreamingWindowsRequest(Msg, <<>>,
				       TrUserData).


encode_msg_StreamingWindowsRequest(#{} = M, Bin,
				   TrUserData) ->
    B1 = case M of
    ...
    case M of
	  ...
	  case id(F1, TrUserData) of
		...
		begin
		  ...
		  e_mfield_TestResult_success(TrTF1, <<Bin/binary, 10>>,
					      TrUserData)
		end;
	    {failure, TF1} ->
		begin
		  TrTF1 = id(TF1, TrUserData),
		  e_mfield_TestResult_failure(TrTF1, <<Bin/binary, 18>>,
					      TrUserData)
		end;
	    {not_implemented, TF1} ->
		begin
...
e_field_TestSuccess_run_results(Elems, Bin, TrUserData)
    ...
    e_pfield_TestSuccess_run_results(Elems, Bin3,
				     TrUserData);
...
e_pfield_TestSuccess_run_results([V | Rest], Bin,
    ...
    e_pfield_TestSuccess_run_results(Rest, Bin2,
				     TrUserData);
...
decode_msg_2_doit('AtomicRegisterRequest', Bin,
    ...
    id(decode_msg_AtomicRegisterRequest(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('StreamingWindowsRequest', Bin,
		  TrUserData) ->
    id(decode_msg_StreamingWindowsRequest(Bin, TrUserData),
       TrUserData);
...
dg_read_field_def_PingPongRequest(<<1:1, X:7,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_PingPongRequest(Rest, N + 7,
...
dg_read_field_def_PingPongRequest(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_PingPongRequest_number_of_messages(Rest, 0, 0,
						     F@_1, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_PingPongRequest(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_PingPongRequest(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_PingPongRequest(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_PingPongRequest(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
...
d_field_PingPongRequest_number_of_messages(<<1:1, X:7,
					   ...
					   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_PingPongRequest_number_of_messages(Rest, N + 7,
					       X bsl N + Acc, F@_1, TrUserData);
d_field_PingPongRequest_number_of_messages(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_PingPongRequest(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_PingPongRequest(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_PingPongRequest(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_PingPongRequest(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_PingPongRequest(Rest, Z1, Z2, F@_1,
				       TrUserData).
...
skip_length_delimited_PingPongRequest(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_PingPongRequest(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_PingPongRequest(<<0:1, X:7,
    ...
    dfp_read_field_def_PingPongRequest(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_PingPongRequest(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_PingPongRequest(Rest, 0, Z2, F@_1,
				       TrUserData).
...
decode_msg_ThroughputPingPongRequest(Bin, TrUserData) ->
    dfp_read_field_def_ThroughputPingPongRequest(Bin, 0, 0,
						 id(0, TrUserData),
						 id(0, TrUserData),
						 id(0, TrUserData),
						 id(false, TrUserData),
...
dfp_read_field_def_ThroughputPingPongRequest(<<24,
					     ...
					     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					     TrUserData) ->
    d_field_ThroughputPingPongRequest_parallelism(Rest, Z1,
...
dfp_read_field_def_ThroughputPingPongRequest(<<32,
					     ...
					     Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					     TrUserData) ->
    d_field_ThroughputPingPongRequest_static_only(Rest, Z1,
						  Z2, F@_1, F@_2, F@_3, F@_4,
						  TrUserData);
dfp_read_field_def_ThroughputPingPongRequest(<<>>, 0, 0,
					     F@_1, F@_2, F@_3, F@_4, _) ->
    #{messages_per_pair => F@_1, pipeline_size => F@_2,
      parallelism => F@_3, static_only => F@_4};
dfp_read_field_def_ThroughputPingPongRequest(Other, Z1,
					     Z2, F@_1, F@_2, F@_3, F@_4,
					     TrUserData) ->
    dg_read_field_def_ThroughputPingPongRequest(Other, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData).
...
dg_read_field_def_ThroughputPingPongRequest(<<1:1, X:7,
					    ...
					    TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ThroughputPingPongRequest(Rest, N + 7,
...
dg_read_field_def_ThroughputPingPongRequest(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_ThroughputPingPongRequest_messages_per_pair(Rest,
							      ...
							      TrUserData);
      16 ->
	  d_field_ThroughputPingPongRequest_pipeline_size(Rest, 0,
							  0, F@_1, F@_2, F@_3,
							  F@_4, TrUserData);
      24 ->
	  d_field_ThroughputPingPongRequest_parallelism(Rest, 0,
							0, F@_1, F@_2, F@_3,
							F@_4, TrUserData);
      32 ->
	  d_field_ThroughputPingPongRequest_static_only(Rest, 0,
							0, F@_1, F@_2, F@_3,
							F@_4, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_ThroughputPingPongRequest(Rest, 0, 0, F@_1,
						      F@_2, F@_3, F@_4,
						      TrUserData);
	    1 ->
		skip_64_ThroughputPingPongRequest(Rest, 0, 0, F@_1,
						  F@_2, F@_3, F@_4, TrUserData);
	    2 ->
		skip_length_delimited_ThroughputPingPongRequest(Rest, 0,
								0, F@_1, F@_2,
								F@_3, F@_4,
								TrUserData);
	    3 ->
		skip_group_ThroughputPingPongRequest(Rest, Key bsr 3, 0,
						     F@_1, F@_2, F@_3, F@_4,
						     TrUserData);
	    5 ->
		skip_32_ThroughputPingPongRequest(Rest, 0, 0, F@_1,
						  F@_2, F@_3, F@_4, TrUserData)
	  end
    end;
...
d_field_ThroughputPingPongRequest_messages_per_pair(<<0:1,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_ThroughputPingPongRequest(RestF, 0,
...
skip_varint_ThroughputPingPongRequest(<<1:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				      TrUserData) ->
    skip_varint_ThroughputPingPongRequest(Rest, Z1, Z2,
					  F@_1, F@_2, F@_3, F@_4, TrUserData);
skip_varint_ThroughputPingPongRequest(<<0:1, _:7,
					Rest/binary>>,
				      Z1, Z2, F@_1, F@_2, F@_3, F@_4,
				      TrUserData) ->
    dfp_read_field_def_ThroughputPingPongRequest(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData).
...
skip_length_delimited_ThroughputPingPongRequest(<<0:1,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ThroughputPingPongRequest(Rest2, 0,
...
skip_group_ThroughputPingPongRequest(Bin, FNum, Z2,
				     F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ThroughputPingPongRequest(Rest, 0,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData).
...
decode_msg_AtomicRegisterRequest(Bin, TrUserData) ->
    dfp_read_field_def_AtomicRegisterRequest(Bin, 0, 0,
					     id(0.0, TrUserData),
					     id(0.0, TrUserData),
					     id(0, TrUserData),
					     id(0, TrUserData), TrUserData).
...
dfp_read_field_def_AtomicRegisterRequest(<<13,
					 ...
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    d_field_AtomicRegisterRequest_read_workload(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
						TrUserData);
dfp_read_field_def_AtomicRegisterRequest(<<21,
					 ...
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    d_field_AtomicRegisterRequest_write_workload(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_AtomicRegisterRequest(<<24,
					 ...
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    d_field_AtomicRegisterRequest_partition_size(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_AtomicRegisterRequest(<<32,
					 ...
					 Z1, Z2, F@_1, F@_2, F@_3, F@_4,
					 TrUserData) ->
    d_field_AtomicRegisterRequest_number_of_keys(Rest, Z1,
						 Z2, F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
dfp_read_field_def_AtomicRegisterRequest(<<>>, 0, 0,
					 F@_1, F@_2, F@_3, F@_4, _) ->
    #{read_workload => F@_1, write_workload => F@_2,
      partition_size => F@_3, number_of_keys => F@_4};
dfp_read_field_def_AtomicRegisterRequest(Other, Z1, Z2,
					 F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    dg_read_field_def_AtomicRegisterRequest(Other, Z1, Z2,
					    F@_1, F@_2, F@_3, F@_4, TrUserData).
...
dg_read_field_def_AtomicRegisterRequest(<<1:1, X:7,
					...
					TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_AtomicRegisterRequest(Rest, N + 7,
					    X bsl N + Acc, F@_1, F@_2, F@_3,
					    F@_4, TrUserData);
dg_read_field_def_AtomicRegisterRequest(<<0:1, X:7,
    ...
    case Key of
      13 ->
	  d_field_AtomicRegisterRequest_read_workload(Rest, 0, 0,
						      F@_1, F@_2, F@_3, F@_4,
						      TrUserData);
      21 ->
	  d_field_AtomicRegisterRequest_write_workload(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      24 ->
	  d_field_AtomicRegisterRequest_partition_size(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      32 ->
	  d_field_AtomicRegisterRequest_number_of_keys(Rest, 0, 0,
						       F@_1, F@_2, F@_3, F@_4,
						       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_AtomicRegisterRequest(Rest, 0, 0, F@_1,
						  F@_2, F@_3, F@_4, TrUserData);
	    1 ->
		skip_64_AtomicRegisterRequest(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, TrUserData);
	    2 ->
		skip_length_delimited_AtomicRegisterRequest(Rest, 0, 0,
							    F@_1, F@_2, F@_3,
							    F@_4, TrUserData);
	    3 ->
		skip_group_AtomicRegisterRequest(Rest, Key bsr 3, 0,
						 F@_1, F@_2, F@_3, F@_4,
						 TrUserData);
	    5 ->
		skip_32_AtomicRegisterRequest(Rest, 0, 0, F@_1, F@_2,
					      F@_3, F@_4, TrUserData)
	  end
    end;
...
d_field_AtomicRegisterRequest_read_workload(<<0:16, 128,
					    ...
					    TrUserData) ->
    dfp_read_field_def_AtomicRegisterRequest(Rest, Z1, Z2,
...
d_field_AtomicRegisterRequest_partition_size(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_AtomicRegisterRequest(RestF, 0, 0,
...
skip_varint_AtomicRegisterRequest(<<1:1, _:7,
				    Rest/binary>>,
				  Z1, Z2, F@_1, F@_2, F@_3, F@_4, TrUserData) ->
    skip_varint_AtomicRegisterRequest(Rest, Z1, Z2, F@_1,
				      F@_2, F@_3, F@_4, TrUserData);
...
skip_length_delimited_AtomicRegisterRequest(<<1:1, X:7,
					    ...
					    TrUserData)
    when N < 57 ->
    skip_length_delimited_AtomicRegisterRequest(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2, F@_3,
						F@_4, TrUserData);
skip_length_delimited_AtomicRegisterRequest(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_AtomicRegisterRequest(Rest2, 0, 0,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData).
...
skip_group_AtomicRegisterRequest(Bin, FNum, Z2, F@_1,
				 F@_2, F@_3, F@_4, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_AtomicRegisterRequest(Rest, 0, Z2,
					     F@_1, F@_2, F@_3, F@_4,
					     TrUserData).
...
decode_msg_StreamingWindowsRequest(Bin, TrUserData) ->
    dfp_read_field_def_StreamingWindowsRequest(Bin, 0, 0,
					       id(0, TrUserData),
					       id(0, TrUserData),
					       id([], TrUserData),
					       id(0, TrUserData),
...
dfp_read_field_def_StreamingWindowsRequest(<<8,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    d_field_StreamingWindowsRequest_number_of_partitions(Rest,
							 Z1, Z2, F@_1, F@_2,
							 F@_3, F@_4, F@_5,
							 TrUserData);
dfp_read_field_def_StreamingWindowsRequest(<<16,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    d_field_StreamingWindowsRequest_batch_size(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData);
dfp_read_field_def_StreamingWindowsRequest(<<26,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    d_field_StreamingWindowsRequest_window_size(Rest, Z1,
						Z2, F@_1, F@_2, F@_3, F@_4,
						F@_5, TrUserData);
dfp_read_field_def_StreamingWindowsRequest(<<32,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    d_field_StreamingWindowsRequest_number_of_windows(Rest,
						      Z1, Z2, F@_1, F@_2, F@_3,
						      F@_4, F@_5, TrUserData);
dfp_read_field_def_StreamingWindowsRequest(<<40,
					     Rest/binary>>,
					   Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    d_field_StreamingWindowsRequest_window_size_amplification(Rest,
							      Z1, Z2, F@_1,
							      F@_2, F@_3, F@_4,
							      F@_5, TrUserData);
dfp_read_field_def_StreamingWindowsRequest(<<>>, 0, 0,
					   F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #{number_of_partitions => F@_1, batch_size => F@_2,
      window_size => F@_3, number_of_windows => F@_4,
      window_size_amplification => F@_5};
dfp_read_field_def_StreamingWindowsRequest(Other, Z1,
					   Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData) ->
    dg_read_field_def_StreamingWindowsRequest(Other, Z1, Z2,
					      F@_1, F@_2, F@_3, F@_4, F@_5,
					      TrUserData).

dg_read_field_def_StreamingWindowsRequest(<<1:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_StreamingWindowsRequest(Rest, N + 7,
					      X bsl N + Acc, F@_1, F@_2, F@_3,
					      F@_4, F@_5, TrUserData);
dg_read_field_def_StreamingWindowsRequest(<<0:1, X:7,
					    Rest/binary>>,
					  N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					  TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
	  ...
	  d_field_StreamingWindowsRequest_number_of_partitions(Rest,
							       ...
							       TrUserData);
      16 ->
	  d_field_StreamingWindowsRequest_batch_size(Rest, 0, 0,
						     F@_1, F@_2, F@_3, F@_4,
						     F@_5, TrUserData);
      26 ->
	  d_field_StreamingWindowsRequest_window_size(Rest, 0, 0,
						      F@_1, F@_2, F@_3, F@_4,
						      F@_5, TrUserData);
      32 ->
	  d_field_StreamingWindowsRequest_number_of_windows(Rest,
	  ...
	  case Key band 7 of
	    0 ->
		skip_varint_StreamingWindowsRequest(Rest, 0, 0, F@_1,
						    F@_2, F@_3, F@_4, F@_5,
						    TrUserData);
	    1 ->
		skip_64_StreamingWindowsRequest(Rest, 0, 0, F@_1, F@_2,
						F@_3, F@_4, F@_5, TrUserData);
	    2 ->
		skip_length_delimited_StreamingWindowsRequest(Rest, 0,
							      0, F@_1, F@_2,
							      F@_3, F@_4, F@_5,
							      TrUserData);
	    3 ->
		skip_group_StreamingWindowsRequest(Rest, Key bsr 3, 0,
						   F@_1, F@_2, F@_3, F@_4, F@_5,
						   TrUserData);
	    5 ->
		skip_32_StreamingWindowsRequest(Rest, 0, 0, F@_1, F@_2,
						F@_3, F@_4, F@_5, TrUserData)
	  end
    end;
dg_read_field_def_StreamingWindowsRequest(<<>>, 0, 0,
					  F@_1, F@_2, F@_3, F@_4, F@_5, _) ->
    #{number_of_partitions => F@_1, batch_size => F@_2,
      window_size => F@_3, number_of_windows => F@_4,
      window_size_amplification => F@_5}.

d_field_StreamingWindowsRequest_number_of_partitions(<<1:1,
						       X:7, Rest/binary>>,
						     N, Acc, F@_1, F@_2, F@_3,
						     F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_StreamingWindowsRequest_number_of_partitions(Rest,
							 ...
							 F@_1, F@_2, F@_3, F@_4,
							 F@_5, TrUserData);
d_field_StreamingWindowsRequest_number_of_partitions(<<0:1,
						       X:7, Rest/binary>>,
						     N, Acc, _, F@_2, F@_3,
						     F@_4, F@_5, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_StreamingWindowsRequest(RestF, 0, 0,
					       NewFValue, F@_2, F@_3, F@_4,
					       F@_5, TrUserData).

d_field_StreamingWindowsRequest_batch_size(<<1:1, X:7,
					     Rest/binary>>,
					   N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5,
					   TrUserData)
    when N < 57 ->
    d_field_StreamingWindowsRequest_batch_size(Rest, N + 7,
					       X bsl N + Acc, F@_1, F@_2, F@_3,
					       F@_4, F@_5, TrUserData);
d_field_StreamingWindowsRequest_batch_size(<<0:1, X:7,
					     Rest/binary>>,
...
d_field_StreamingWindowsRequest_window_size(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, F@_3, F@_4,
					    F@_5, TrUserData)
    when N < 57 ->
    d_field_StreamingWindowsRequest_window_size(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2, F@_3,
						F@_4, F@_5, TrUserData);
d_field_StreamingWindowsRequest_window_size(<<0:1, X:7,
					      Rest/binary>>,
...
d_field_StreamingWindowsRequest_number_of_windows(<<1:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2, F@_3,
						  F@_4, F@_5, TrUserData)
    when N < 57 ->
    d_field_StreamingWindowsRequest_number_of_windows(Rest,
						      ...
						      F@_1, F@_2, F@_3, F@_4,
						      F@_5, TrUserData);
d_field_StreamingWindowsRequest_number_of_windows(<<0:1,
						    X:7, Rest/binary>>,
						  N, Acc, F@_1, F@_2, F@_3, _,
						  F@_5, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
...
d_field_StreamingWindowsRequest_window_size_amplification(<<1:1,
							    X:7, Rest/binary>>,
							  N, Acc, F@_1, F@_2,
							  F@_3, F@_4, F@_5,
							  TrUserData)
    ...
    d_field_StreamingWindowsRequest_window_size_amplification(Rest,
							      ...
							      F@_4, F@_5,
							      TrUserData);
d_field_StreamingWindowsRequest_window_size_amplification(<<0:1,
							    X:7, Rest/binary>>,
							  N, Acc, F@_1, F@_2,
							  F@_3, F@_4, _,
							  TrUserData) ->
...
skip_varint_StreamingWindowsRequest(<<1:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData) ->
    skip_varint_StreamingWindowsRequest(Rest, Z1, Z2, F@_1,
					F@_2, F@_3, F@_4, F@_5, TrUserData);
skip_varint_StreamingWindowsRequest(<<0:1, _:7,
				      Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				    TrUserData) ->
    dfp_read_field_def_StreamingWindowsRequest(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData).

skip_length_delimited_StreamingWindowsRequest(<<1:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3, F@_4,
					      F@_5, TrUserData)
    when N < 57 ->
    skip_length_delimited_StreamingWindowsRequest(Rest,
						  N + 7, X bsl N + Acc, F@_1,
						  F@_2, F@_3, F@_4, F@_5,
						  TrUserData);
skip_length_delimited_StreamingWindowsRequest(<<0:1,
						X:7, Rest/binary>>,
					      N, Acc, F@_1, F@_2, F@_3, F@_4,
					      F@_5, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_StreamingWindowsRequest(Rest2, 0, 0,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData).

skip_group_StreamingWindowsRequest(Bin, FNum, Z2, F@_1,
				   F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_StreamingWindowsRequest(Rest, 0, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
					       TrUserData).

skip_32_StreamingWindowsRequest(<<_:32, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				TrUserData) ->
    dfp_read_field_def_StreamingWindowsRequest(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
...
skip_64_StreamingWindowsRequest(<<_:64, Rest/binary>>,
				Z1, Z2, F@_1, F@_2, F@_3, F@_4, F@_5,
				TrUserData) ->
    dfp_read_field_def_StreamingWindowsRequest(Rest, Z1, Z2,
					       F@_1, F@_2, F@_3, F@_4, F@_5,
...
decode_msg_TestResult(Bin, TrUserData) ->
    dfp_read_field_def_TestResult(Bin, 0, 0,
				  id('$undef', TrUserData), TrUserData).

dfp_read_field_def_TestResult(<<10, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    d_field_TestResult_success(Rest, Z1, Z2, F@_1,
			       TrUserData);
dfp_read_field_def_TestResult(<<18, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    d_field_TestResult_failure(Rest, Z1, Z2, F@_1,
			       TrUserData);
dfp_read_field_def_TestResult(<<26, Rest/binary>>, Z1,
			      Z2, F@_1, TrUserData) ->
    d_field_TestResult_not_implemented(Rest, Z1, Z2, F@_1,
				       TrUserData);
...
dfp_read_field_def_TestResult(Other, Z1, Z2, F@_1,
			      TrUserData) ->
    dg_read_field_def_TestResult(Other, Z1, Z2, F@_1,
				 TrUserData).

dg_read_field_def_TestResult(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_TestResult(Rest, N + 7, X bsl N + Acc,
				 F@_1, TrUserData);
dg_read_field_def_TestResult(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_TestResult_success(Rest, 0, 0, F@_1,
				     TrUserData);
      18 ->
	  d_field_TestResult_failure(Rest, 0, 0, F@_1,
				     TrUserData);
      26 ->
	  d_field_TestResult_not_implemented(Rest, 0, 0, F@_1,
					     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
	    ...
	    2 ->
		skip_length_delimited_TestResult(Rest, 0, 0, F@_1,
						 TrUserData);
	    3 ->
		skip_group_TestResult(Rest, Key bsr 3, 0, F@_1,
				      TrUserData);
...
d_field_TestResult_success(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_TestResult_success(Rest, N + 7, X bsl N + Acc,
			       F@_1, TrUserData);
d_field_TestResult_success(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_TestResult(RestF, 0, 0,
				  case Prev of
				    '$undef' ->
...
d_field_TestResult_failure(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_TestResult_failure(Rest, N + 7, X bsl N + Acc,
			       F@_1, TrUserData);
...
d_field_TestResult_not_implemented(<<1:1, X:7,
				   ...
				   N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_TestResult_not_implemented(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
...
skip_varint_TestResult(<<0:1, _:7, Rest/binary>>, Z1,
		       Z2, F@_1, TrUserData) ->
    dfp_read_field_def_TestResult(Rest, Z1, Z2, F@_1,
				  TrUserData).
...
skip_length_delimited_TestResult(<<1:1, X:7,
				 ...
				 N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_TestResult(Rest, N + 7,
				     X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_TestResult(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_TestResult(Rest2, 0, 0, F@_1,
				  TrUserData).

skip_group_TestResult(Bin, FNum, Z2, F@_1,
		      TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_TestResult(Rest, 0, Z2, F@_1,
				  TrUserData).
...
decode_msg_TestSuccess(Bin, TrUserData) ->
    dfp_read_field_def_TestSuccess(Bin, 0, 0,
				   id(0, TrUserData), id([], TrUserData),
				   TrUserData).

dfp_read_field_def_TestSuccess(<<8, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_field_TestSuccess_number_of_runs(Rest, Z1, Z2, F@_1,
				       F@_2, TrUserData);
dfp_read_field_def_TestSuccess(<<18, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_pfield_TestSuccess_run_results(Rest, Z1, Z2, F@_1,
				     F@_2, TrUserData);
dfp_read_field_def_TestSuccess(<<17, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_field_TestSuccess_run_results(Rest, Z1, Z2, F@_1,
				    F@_2, TrUserData);
...
dfp_read_field_def_TestSuccess(Other, Z1, Z2, F@_1,
			       F@_2, TrUserData) ->
    dg_read_field_def_TestSuccess(Other, Z1, Z2, F@_1, F@_2,
				  TrUserData).

dg_read_field_def_TestSuccess(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_TestSuccess(Rest, N + 7,
...
dg_read_field_def_TestSuccess(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      8 ->
	  d_field_TestSuccess_number_of_runs(Rest, 0, 0, F@_1,
					     F@_2, TrUserData);
      18 ->
	  d_pfield_TestSuccess_run_results(Rest, 0, 0, F@_1, F@_2,
					   TrUserData);
      17 ->
	  d_field_TestSuccess_run_results(Rest, 0, 0, F@_1, F@_2,
					  TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_TestSuccess(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
	    1 ->
		skip_64_TestSuccess(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 ->
		skip_length_delimited_TestSuccess(Rest, 0, 0, F@_1,
						  F@_2, TrUserData);
	    3 ->
		skip_group_TestSuccess(Rest, Key bsr 3, 0, F@_1, F@_2,
				       TrUserData);
	    5 ->
...
d_field_TestSuccess_number_of_runs(<<1:1, X:7,
				   ...
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_TestSuccess_number_of_runs(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_TestSuccess_number_of_runs(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_TestSuccess(RestF, 0, 0, NewFValue,
				   F@_2, TrUserData).

d_field_TestSuccess_run_results(<<0:48, 240, 127,
				  Rest/binary>>,
				Z1, Z2, F@_1, Prev, TrUserData) ->
    dfp_read_field_def_TestSuccess(Rest, Z1, Z2, F@_1,
...
d_pfield_TestSuccess_run_results(<<1:1, X:7,
				 ...
				 N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_pfield_TestSuccess_run_results(Rest, N + 7,
				     X bsl N + Acc, F@_1, F@_2, TrUserData);
d_pfield_TestSuccess_run_results(<<0:1, X:7,
    ...
    NewSeq =
	d_packed_field_TestSuccess_run_results(PackedBytes, 0,
					       0, E, TrUserData),
    dfp_read_field_def_TestSuccess(Rest2, 0, 0, F@_1,
				   NewSeq, TrUserData).

d_packed_field_TestSuccess_run_results(<<0:48, 240, 127,
					 Rest/binary>>,
				       Z1, Z2, AccSeq, TrUserData) ->
    d_packed_field_TestSuccess_run_results(Rest, Z1, Z2,
...
skip_varint_TestSuccess(<<1:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_TestSuccess(Rest, Z1, Z2, F@_1, F@_2,
			    TrUserData);
skip_varint_TestSuccess(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_TestSuccess(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData).
...
skip_length_delimited_TestSuccess(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_TestSuccess(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_TestSuccess(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_TestSuccess(Rest2, 0, 0, F@_1, F@_2,
				   TrUserData).

skip_group_TestSuccess(Bin, FNum, Z2, F@_1, F@_2,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_TestSuccess(Rest, 0, Z2, F@_1, F@_2,
				   TrUserData).
...
dg_read_field_def_TestFailure(<<0:1, X:7, Rest/binary>>,
    ...
    case Key of
      10 ->
	  d_field_TestFailure_reason(Rest, 0, 0, F@_1,
				     TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
	    ...
	    2 ->
		skip_length_delimited_TestFailure(Rest, 0, 0, F@_1,
						  TrUserData);
	    3 ->
		skip_group_TestFailure(Rest, Key bsr 3, 0, F@_1,
				       TrUserData);
...
d_field_TestFailure_reason(<<1:1, X:7, Rest/binary>>, N,
			   Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_TestFailure_reason(Rest, N + 7, X bsl N + Acc,
			       F@_1, TrUserData);
d_field_TestFailure_reason(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_TestFailure(RestF, 0, 0, NewFValue,
				   TrUserData).
...
skip_varint_TestFailure(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, TrUserData) ->
    dfp_read_field_def_TestFailure(Rest, Z1, Z2, F@_1,
				   TrUserData).
...
skip_length_delimited_TestFailure(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_TestFailure(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_TestFailure(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_TestFailure(Rest2, 0, 0, F@_1,
				   TrUserData).

skip_group_TestFailure(Bin, FNum, Z2, F@_1,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_TestFailure(Rest, 0, Z2, F@_1,
				   TrUserData).
...
decode_msg_NotImplemented(Bin, TrUserData) ->
    dfp_read_field_def_NotImplemented(Bin, 0, 0,
				      TrUserData).

dfp_read_field_def_NotImplemented(<<>>, 0, 0, _) -> #{};
dfp_read_field_def_NotImplemented(Other, Z1, Z2,
				  TrUserData) ->
    dg_read_field_def_NotImplemented(Other, Z1, Z2,
				     TrUserData).
...
dg_read_field_def_NotImplemented(<<1:1, X:7,
				 ...
				 N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_NotImplemented(Rest, N + 7,
...
dg_read_field_def_NotImplemented(<<0:1, X:7,
    ...
    case Key band 7 of
      ...
      2 ->
	  skip_length_delimited_NotImplemented(Rest, 0, 0,
					       TrUserData);
      3 ->
	  skip_group_NotImplemented(Rest, Key bsr 3, 0,
				    TrUserData);
...
skip_varint_NotImplemented(<<0:1, _:7, Rest/binary>>,
			   Z1, Z2, TrUserData) ->
    dfp_read_field_def_NotImplemented(Rest, Z1, Z2,
				      TrUserData).
...
skip_length_delimited_NotImplemented(<<1:1, X:7,
				     ...
				     N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_NotImplemented(Rest, N + 7,
					 X bsl N + Acc, TrUserData);
skip_length_delimited_NotImplemented(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_NotImplemented(Rest2, 0, 0,
				      TrUserData).

skip_group_NotImplemented(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_NotImplemented(Rest, 0, Z2,
				      TrUserData).
...
dfp_read_field_def_ReadyRequest(Other, Z1, Z2,
				TrUserData) ->
    dg_read_field_def_ReadyRequest(Other, Z1, Z2,
				   TrUserData).
...
dg_read_field_def_ReadyRequest(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ReadyRequest(Rest, N + 7,
				   X bsl N + Acc, TrUserData);
dg_read_field_def_ReadyRequest(<<0:1, X:7,
    ...
    case Key band 7 of
      ...
      2 ->
	  skip_length_delimited_ReadyRequest(Rest, 0, 0,
					     TrUserData);
      3 ->
...
skip_varint_ReadyRequest(<<0:1, _:7, Rest/binary>>, Z1,
			 Z2, TrUserData) ->
    dfp_read_field_def_ReadyRequest(Rest, Z1, Z2,
				    TrUserData).
...
skip_length_delimited_ReadyRequest(<<1:1, X:7,
				   ...
				   N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_ReadyRequest(Rest, N + 7,
				       X bsl N + Acc, TrUserData);
skip_length_delimited_ReadyRequest(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ReadyRequest(Rest2, 0, 0,
				    TrUserData).

skip_group_ReadyRequest(Bin, FNum, Z2, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ReadyRequest(Rest, 0, Z2,
				    TrUserData).
...
dg_read_field_def_ReadyResponse(<<1:1, X:7,
				...
				N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ReadyResponse(Rest, N + 7,
				    X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_ReadyResponse(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_ReadyResponse_status(Rest, 0, 0, F@_1,
				       TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
	    ...
	    2 ->
		skip_length_delimited_ReadyResponse(Rest, 0, 0, F@_1,
						    TrUserData);
	    3 ->
		skip_group_ReadyResponse(Rest, Key bsr 3, 0, F@_1,
					 TrUserData);
...
d_field_ReadyResponse_status(<<1:1, X:7, Rest/binary>>,
			     N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_ReadyResponse_status(Rest, N + 7, X bsl N + Acc,
				 F@_1, TrUserData);
d_field_ReadyResponse_status(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_ReadyResponse(RestF, 0, 0, NewFValue,
				     TrUserData).

skip_varint_ReadyResponse(<<1:1, _:7, Rest/binary>>, Z1,
			  Z2, F@_1, TrUserData) ->
    skip_varint_ReadyResponse(Rest, Z1, Z2, F@_1,
			      TrUserData);
skip_varint_ReadyResponse(<<0:1, _:7, Rest/binary>>, Z1,
			  Z2, F@_1, TrUserData) ->
    dfp_read_field_def_ReadyResponse(Rest, Z1, Z2, F@_1,
				     TrUserData).
...
skip_length_delimited_ReadyResponse(<<1:1, X:7,
				    ...
				    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_ReadyResponse(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_ReadyResponse(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ReadyResponse(Rest2, 0, 0, F@_1,
				     TrUserData).

skip_group_ReadyResponse(Bin, FNum, Z2, F@_1,
			 TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ReadyResponse(Rest, 0, Z2, F@_1,
				     TrUserData).
...
decode_msg_ShutdownRequest(Bin, TrUserData) ->
    dfp_read_field_def_ShutdownRequest(Bin, 0, 0,
				       id(false, TrUserData), TrUserData).

dfp_read_field_def_ShutdownRequest(<<8, Rest/binary>>,
				   Z1, Z2, F@_1, TrUserData) ->
    d_field_ShutdownRequest_force(Rest, Z1, Z2, F@_1,
				  TrUserData);
...
dfp_read_field_def_ShutdownRequest(Other, Z1, Z2, F@_1,
				   TrUserData) ->
    dg_read_field_def_ShutdownRequest(Other, Z1, Z2, F@_1,
				      TrUserData).
...
dg_read_field_def_ShutdownRequest(<<1:1, X:7,
				  ...
				  N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ShutdownRequest(Rest, N + 7,
				      X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_ShutdownRequest(<<0:1, X:7,
    ...
    case Key of
      8 ->
	  d_field_ShutdownRequest_force(Rest, 0, 0, F@_1,
					TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_ShutdownRequest(Rest, 0, 0, F@_1,
					    TrUserData);
	    1 ->
		skip_64_ShutdownRequest(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_ShutdownRequest(Rest, 0, 0, F@_1,
						      TrUserData);
	    3 ->
		skip_group_ShutdownRequest(Rest, Key bsr 3, 0, F@_1,
					   TrUserData);
	    5 ->
...
d_field_ShutdownRequest_force(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_ShutdownRequest_force(Rest, N + 7,
				  X bsl N + Acc, F@_1, TrUserData);
d_field_ShutdownRequest_force(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
			     TrUserData),
			  Rest},
    dfp_read_field_def_ShutdownRequest(RestF, 0, 0,
				       NewFValue, TrUserData).

skip_varint_ShutdownRequest(<<1:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    skip_varint_ShutdownRequest(Rest, Z1, Z2, F@_1,
				TrUserData);
skip_varint_ShutdownRequest(<<0:1, _:7, Rest/binary>>,
			    Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_ShutdownRequest(Rest, Z1, Z2, F@_1,
				       TrUserData).
...
skip_length_delimited_ShutdownRequest(<<1:1, X:7,
					Rest/binary>>,
				      N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_ShutdownRequest(Rest, N + 7,
					  X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_ShutdownRequest(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ShutdownRequest(Rest2, 0, 0, F@_1,
				       TrUserData).

skip_group_ShutdownRequest(Bin, FNum, Z2, F@_1,
			   TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ShutdownRequest(Rest, 0, Z2, F@_1,
				       TrUserData).
...
dfp_read_field_def_ShutdownAck(Other, Z1, Z2,
			       TrUserData) ->
    dg_read_field_def_ShutdownAck(Other, Z1, Z2,
				  TrUserData).

dg_read_field_def_ShutdownAck(<<1:1, X:7, Rest/binary>>,
			      N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ShutdownAck(Rest, N + 7,
				  X bsl N + Acc, TrUserData);
dg_read_field_def_ShutdownAck(<<0:1, X:7, Rest/binary>>,
    ...
    case Key band 7 of
      ...
      2 ->
	  skip_length_delimited_ShutdownAck(Rest, 0, 0,
					    TrUserData);
      3 ->
...
skip_varint_ShutdownAck(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, TrUserData) ->
    dfp_read_field_def_ShutdownAck(Rest, Z1, Z2,
				   TrUserData).
...
skip_length_delimited_ShutdownAck(<<1:1, X:7,
				  ...
				  N, Acc, TrUserData)
    when N < 57 ->
    skip_length_delimited_ShutdownAck(Rest, N + 7,
				      X bsl N + Acc, TrUserData);
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'ThroughputPingPongRequest' ->
	  merge_msg_ThroughputPingPongRequest(Prev, New,
					      TrUserData);
      'AtomicRegisterRequest' ->
	  merge_msg_AtomicRegisterRequest(Prev, New, TrUserData);
      'StreamingWindowsRequest' ->
	  merge_msg_StreamingWindowsRequest(Prev, New,
					    TrUserData);
      'TestResult' ->
...
merge_msg_PingPongRequest(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
      {_, #{number_of_messages := NFnumber_of_messages}} ->
	  S1#{number_of_messages => NFnumber_of_messages};
      {#{number_of_messages := PFnumber_of_messages}, _} ->
	  S1#{number_of_messages => PFnumber_of_messages};
      _ -> S1
    end.
...
merge_msg_ThroughputPingPongRequest(PMsg, NMsg, _) ->
    ...
    S2 = case {PMsg, NMsg} of
	   {_, #{messages_per_pair := NFmessages_per_pair}} ->
	       S1#{messages_per_pair => NFmessages_per_pair};
	   {#{messages_per_pair := PFmessages_per_pair}, _} ->
	       S1#{messages_per_pair => PFmessages_per_pair};
	   _ -> S1
	 end,
    S3 = case {PMsg, NMsg} of
	   {_, #{pipeline_size := NFpipeline_size}} ->
	       S2#{pipeline_size => NFpipeline_size};
	   {#{pipeline_size := PFpipeline_size}, _} ->
	       S2#{pipeline_size => PFpipeline_size};
	   _ -> S2
	 end,
    S4 = case {PMsg, NMsg} of
	   {_, #{parallelism := NFparallelism}} ->
	       S3#{parallelism => NFparallelism};
	   {#{parallelism := PFparallelism}, _} ->
	       S3#{parallelism => PFparallelism};
	   _ -> S3
	 end,
    case {PMsg, NMsg} of
      {_, #{static_only := NFstatic_only}} ->
	  S4#{static_only => NFstatic_only};
      {#{static_only := PFstatic_only}, _} ->
	  S4#{static_only => PFstatic_only};
      _ -> S4
    end.
...
merge_msg_AtomicRegisterRequest(PMsg, NMsg, _) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {_, #{read_workload := NFread_workload}} ->
	       S1#{read_workload => NFread_workload};
	   {#{read_workload := PFread_workload}, _} ->
	       S1#{read_workload => PFread_workload};
	   _ -> S1
	 end,
    S3 = case {PMsg, NMsg} of
	   {_, #{write_workload := NFwrite_workload}} ->
	       S2#{write_workload => NFwrite_workload};
	   {#{write_workload := PFwrite_workload}, _} ->
	       S2#{write_workload => PFwrite_workload};
	   _ -> S2
	 end,
    S4 = case {PMsg, NMsg} of
	   {_, #{partition_size := NFpartition_size}} ->
	       S3#{partition_size => NFpartition_size};
	   {#{partition_size := PFpartition_size}, _} ->
	       S3#{partition_size => PFpartition_size};
	   _ -> S3
	 end,
    case {PMsg, NMsg} of
      {_, #{number_of_keys := NFnumber_of_keys}} ->
	  S4#{number_of_keys => NFnumber_of_keys};
      {#{number_of_keys := PFnumber_of_keys}, _} ->
	  S4#{number_of_keys => PFnumber_of_keys};
      _ -> S4
    end.
...
merge_msg_StreamingWindowsRequest(PMsg, NMsg, _) ->
    ...
    S2 = case {PMsg, NMsg} of
	   {_,
	    #{number_of_partitions := NFnumber_of_partitions}} ->
	       S1#{number_of_partitions => NFnumber_of_partitions};
	   {#{number_of_partitions := PFnumber_of_partitions},
	    _} ->
	       S1#{number_of_partitions => PFnumber_of_partitions};
	   _ -> S1
	 end,
    S3 = case {PMsg, NMsg} of
	   {_, #{batch_size := NFbatch_size}} ->
	       S2#{batch_size => NFbatch_size};
	   {#{batch_size := PFbatch_size}, _} ->
	       S2#{batch_size => PFbatch_size};
	   _ -> S2
	 end,
    S4 = case {PMsg, NMsg} of
	   {_, #{window_size := NFwindow_size}} ->
	       S3#{window_size => NFwindow_size};
	   {#{window_size := PFwindow_size}, _} ->
	       S3#{window_size => PFwindow_size};
	   _ -> S3
	 end,
    S5 = case {PMsg, NMsg} of
	   {_, #{number_of_windows := NFnumber_of_windows}} ->
	       S4#{number_of_windows => NFnumber_of_windows};
	   {#{number_of_windows := PFnumber_of_windows}, _} ->
	       S4#{number_of_windows => PFnumber_of_windows};
	   _ -> S4
	 end,
    case {PMsg, NMsg} of
      {_,
       #{window_size_amplification :=
	     NFwindow_size_amplification}} ->
	  S5#{window_size_amplification =>
		  NFwindow_size_amplification};
      {#{window_size_amplification :=
	     PFwindow_size_amplification},
       _} ->
	  S5#{window_size_amplification =>
		  PFwindow_size_amplification};
      _ -> S5
...
merge_msg_TestResult(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    case {PMsg, NMsg} of
      {#{sealed_value := {success, OPFsealed_value}},
       #{sealed_value := {success, ONFsealed_value}}} ->
	  S1#{sealed_value =>
		  {success,
		   merge_msg_TestSuccess(OPFsealed_value, ONFsealed_value,
					 TrUserData)}};
      {#{sealed_value := {failure, OPFsealed_value}},
       #{sealed_value := {failure, ONFsealed_value}}} ->
	  S1#{sealed_value =>
		  {failure,
		   merge_msg_TestFailure(OPFsealed_value, ONFsealed_value,
					 TrUserData)}};
      {#{sealed_value := {not_implemented, OPFsealed_value}},
       #{sealed_value :=
	     {not_implemented, ONFsealed_value}}} ->
	  S1#{sealed_value =>
		  {not_implemented,
		   merge_msg_NotImplemented(OPFsealed_value,
					    ONFsealed_value, TrUserData)}};
      {_, #{sealed_value := NFsealed_value}} ->
	  S1#{sealed_value => NFsealed_value};
      {#{sealed_value := PFsealed_value}, _} ->
	  S1#{sealed_value => PFsealed_value};
      {_, _} -> S1
    end.
...
merge_msg_TestSuccess(PMsg, NMsg, TrUserData) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {_, #{number_of_runs := NFnumber_of_runs}} ->
	       S1#{number_of_runs => NFnumber_of_runs};
	   {#{number_of_runs := PFnumber_of_runs}, _} ->
	       S1#{number_of_runs => PFnumber_of_runs};
	   _ -> S1
	 end,
    case {PMsg, NMsg} of
	  ...
	  S2#{run_results =>
		  'erlang_++'(PFrun_results, NFrun_results, TrUserData)};
      {_, #{run_results := NFrun_results}} ->
	  S2#{run_results => NFrun_results};
      {#{run_results := PFrun_results}, _} ->
	  S2#{run_results => PFrun_results};
      {_, _} -> S2
    end.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
      ...
      'ThroughputPingPongRequest' ->
	  v_msg_ThroughputPingPongRequest(Msg, [MsgName],
					  TrUserData);
      'AtomicRegisterRequest' ->
	  v_msg_AtomicRegisterRequest(Msg, [MsgName], TrUserData);
      'StreamingWindowsRequest' ->
	  v_msg_StreamingWindowsRequest(Msg, [MsgName],
					TrUserData);
      'TestResult' ->
...
v_msg_PingPongRequest(#{} = M, Path, TrUserData) ->
    case M of
      #{number_of_messages := F1} ->
	  v_type_uint64(F1, [number_of_messages | Path],
			TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (number_of_messages) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_PingPongRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'PingPongRequest'},
		  M, Path);
v_msg_PingPongRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'PingPongRequest'}, X,
		  Path).
...
v_msg_ThroughputPingPongRequest(#{} = M, Path,
				TrUserData) ->
    case M of
      #{messages_per_pair := F1} ->
	  v_type_uint64(F1, [messages_per_pair | Path],
			TrUserData);
      _ -> ok
    end,
    case M of
    ...
    lists:foreach(fun (messages_per_pair) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_ThroughputPingPongRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ThroughputPingPongRequest'},
		  M, Path);
...
v_msg_AtomicRegisterRequest(#{} = M, Path,
			    TrUserData) ->
    case M of
      #{read_workload := F1} ->
    ...
    lists:foreach(fun (read_workload) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_AtomicRegisterRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'AtomicRegisterRequest'},
		  M, Path);
...
v_msg_StreamingWindowsRequest(#{} = M, Path,
			      TrUserData) ->
    case M of
      #{number_of_partitions := F1} ->
	  v_type_uint32(F1, [number_of_partitions | Path],
			TrUserData);
      _ -> ok
    end,
    case M of
      #{batch_size := F2} ->
	  v_type_uint64(F2, [batch_size | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{window_size := F3} ->
	  v_type_string(F3, [window_size | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{number_of_windows := F4} ->
	  v_type_uint64(F4, [number_of_windows | Path],
			TrUserData);
      _ -> ok
    end,
    case M of
      #{window_size_amplification := F5} ->
	  v_type_uint64(F5, [window_size_amplification | Path],
			TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (number_of_partitions) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_StreamingWindowsRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'StreamingWindowsRequest'},
		  M, Path);
v_msg_StreamingWindowsRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'StreamingWindowsRequest'},
		  X, Path).
...
v_msg_TestResult(#{} = M, Path, TrUserData) ->
    case M of
      #{sealed_value := {success, OF1}} ->
	  v_msg_TestSuccess(OF1, [success, sealed_value | Path],
			    TrUserData);
      #{sealed_value := {failure, OF1}} ->
	  v_msg_TestFailure(OF1, [failure, sealed_value | Path],
			    TrUserData);
      #{sealed_value := {not_implemented, OF1}} ->
    ...
    lists:foreach(fun (sealed_value) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_TestResult(M, Path, _TrUserData) when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'TestResult'},
		  M, Path);
...
v_msg_TestSuccess(#{} = M, Path, TrUserData) ->
    ...
    case M of
      #{run_results := F2} ->
	  if is_list(F2) ->
		 _ = [v_type_double(Elem, [run_results | Path],
				    TrUserData)
		      || Elem <- F2],
		 ok;
	     true ->
		 mk_type_error({invalid_list_of, double}, F2,
			       [run_results | Path])
	  end;
      _ -> ok
    end,
    lists:foreach(fun (number_of_runs) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_TestSuccess(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'TestSuccess'},
		  M, Path);
...
v_msg_TestFailure(#{} = M, Path, TrUserData) ->
    case M of
      #{reason := F1} ->
	  v_type_string(F1, [reason | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (reason) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_TestFailure(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'TestFailure'},
		  M, Path);
...
v_msg_NotImplemented(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) ->
		  ...
		  maps:keys(M)),
    ok;
v_msg_NotImplemented(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'NotImplemented'},
		  M, Path);
v_msg_NotImplemented(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'NotImplemented'}, X,
		  Path).
...
v_msg_ReadyRequest(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) ->
		  ...
		  maps:keys(M)),
    ok;
v_msg_ReadyRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ReadyRequest'},
		  M, Path);
...
v_msg_ReadyResponse(#{} = M, Path, TrUserData) ->
    case M of
      #{status := F1} ->
	  v_type_bool(F1, [status | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (status) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_ReadyResponse(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ReadyResponse'},
		  M, Path);
...
v_msg_ShutdownRequest(#{} = M, Path, TrUserData) ->
    case M of
      #{force := F1} ->
	  v_type_bool(F1, [force | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (force) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_ShutdownRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ShutdownRequest'},
		  M, Path);
v_msg_ShutdownRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'ShutdownRequest'}, X,
		  Path).
...
v_msg_ShutdownAck(#{} = M, Path, _) ->
    lists:foreach(fun (OtherKey) ->
		  ...
		  maps:keys(M)),
    ok;
v_msg_ShutdownAck(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ShutdownAck'},
		  M, Path);
...
get_msg_defs() ->
    [{{msg, 'PingPongRequest'},
      [#{name => number_of_messages, fnum => 1, rnum => 2,
	 type => uint64, occurrence => optional, opts => []}]},
     {{msg, 'ThroughputPingPongRequest'},
      [#{name => messages_per_pair, fnum => 1, rnum => 2,
	 type => uint64, occurrence => optional, opts => []},
       #{name => pipeline_size, fnum => 2, rnum => 3,
	 type => uint64, occurrence => optional, opts => []},
       #{name => parallelism, fnum => 3, rnum => 4,
	 type => uint32, occurrence => optional, opts => []},
       #{name => static_only, fnum => 4, rnum => 5,
	 type => bool, occurrence => optional, opts => []}]},
     {{msg, 'AtomicRegisterRequest'},
      [#{name => read_workload, fnum => 1, rnum => 2,
	 type => float, occurrence => optional, opts => []},
       #{name => write_workload, fnum => 2, rnum => 3,
	 type => float, occurrence => optional, opts => []},
       #{name => partition_size, fnum => 3, rnum => 4,
	 type => uint32, occurrence => optional, opts => []},
       #{name => number_of_keys, fnum => 4, rnum => 5,
	 type => uint64, occurrence => optional, opts => []}]},
     {{msg, 'StreamingWindowsRequest'},
      [#{name => number_of_partitions, fnum => 1, rnum => 2,
	 type => uint32, occurrence => optional, opts => []},
       #{name => batch_size, fnum => 2, rnum => 3,
	 type => uint64, occurrence => optional, opts => []},
       #{name => window_size, fnum => 3, rnum => 4,
	 type => string, occurrence => optional, opts => []},
       #{name => number_of_windows, fnum => 4, rnum => 5,
	 type => uint64, occurrence => optional, opts => []},
       #{name => window_size_amplification, fnum => 5,
	 ...
	 fields =>
		...
		opts => []},
	      #{name => failure, fnum => 2, rnum => 2,
		type => {msg, 'TestFailure'}, occurrence => optional,
		opts => []},
	      #{name => not_implemented, fnum => 3, rnum => 2,
		type => {msg, 'NotImplemented'}, occurrence => optional,
		opts => []}]}]},
     {{msg, 'TestSuccess'},
      [#{name => number_of_runs, fnum => 1, rnum => 2,
	 type => uint32, occurrence => optional, opts => []},
       #{name => run_results, fnum => 2, rnum => 3,
	 type => double, occurrence => repeated,
	 opts => [packed]}]},
     {{msg, 'TestFailure'},
      [#{name => reason, fnum => 1, rnum => 2, type => string,
	 occurrence => optional, opts => []}]},
     {{msg, 'NotImplemented'}, []},
     {{msg, 'ReadyRequest'}, []},
     {{msg, 'ReadyResponse'},
      [#{name => status, fnum => 1, rnum => 2, type => bool,
	 occurrence => optional, opts => []}]},
     {{msg, 'ShutdownRequest'},
      [#{name => force, fnum => 1, rnum => 2, type => bool,
	 occurrence => optional, opts => []}]},
     {{msg, 'ShutdownAck'}, []}].


get_msg_names() ->
    ['PingPongRequest', 'ThroughputPingPongRequest',
     'AtomicRegisterRequest', 'StreamingWindowsRequest',
     'TestResult', 'TestSuccess', 'TestFailure',
     'NotImplemented', 'ReadyRequest', 'ReadyResponse',
...
get_service_def('BenchmarkRunner') ->
    {{service, 'BenchmarkRunner'},
     [#{name => 'Ready', input => 'ReadyRequest',
	output => 'ReadyResponse', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'Shutdown', input => 'ShutdownRequest',
	output => 'ShutdownAck', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'PingPong', input => 'PingPongRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'NetPingPong', input => 'PingPongRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'ThroughputPingPong',
	input => 'ThroughputPingPongRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'NetThroughputPingPong',
	input => 'ThroughputPingPongRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'AtomicRegister',
	input => 'AtomicRegisterRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'StreamingWindows',
	input => 'StreamingWindowsRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []}]};
...
get_rpc_names('BenchmarkRunner') ->
    ['Ready', 'Shutdown', 'PingPong', 'NetPingPong',
     'ThroughputPingPong', 'NetThroughputPingPong',
     'AtomicRegister', 'StreamingWindows'];
...
find_rpc_def_BenchmarkRunner('AtomicRegister') ->
    #{name => 'AtomicRegister',
      ...
      output => 'TestResult', input_stream => false,
      output_stream => false, opts => []};
find_rpc_def_BenchmarkRunner('StreamingWindows') ->
    #{name => 'StreamingWindows',
      input => 'StreamingWindowsRequest',
      output => 'TestResult', input_stream => false,
      output_stream => false, opts => []};
...
fqbins_to_service_and_rpc_name(<<"kompics.benchmarks.BenchmarkRunner">>, <<"StreamingWindows">>) ->
...
service_and_rpc_name_to_fqbins('BenchmarkRunner',
			       'StreamingWindows') ->
    {<<"kompics.benchmarks.BenchmarkRunner">>, <<"StreamingWindows">>};
...
get_msg_containment("benchmarks") ->
    ['AtomicRegisterRequest', 'PingPongRequest',
     'StreamingWindowsRequest', 'ThroughputPingPongRequest'];
get_msg_containment("messages") ->
    ['NotImplemented', 'ReadyRequest', 'ReadyResponse',
     'ShutdownAck', 'ShutdownRequest', 'TestFailure',
...
-type 'FibonacciRequest'() ::
      #{fib_number              => non_neg_integer() % = 1, 32 bits
       }.

-type 'ChameneosRequest'() ::
      #{number_of_chameneos     => non_neg_integer(), % = 1, 32 bits
        number_of_meetings      => non_neg_integer() % = 2, 32 bits
       }.

-type 'APSPRequest'() ::
      #{number_of_nodes         => non_neg_integer(), % = 1, 32 bits
        block_size              => non_neg_integer() % = 2, 32 bits
       }.
...
-export_type(['PingPongRequest'/0, 'ThroughputPingPongRequest'/0, 'AtomicRegisterRequest'/0, 'StreamingWindowsRequest'/0, 'FibonacciRequest'/0, 'ChameneosRequest'/0, 'APSPRequest'/0, 'TestResult'/0, 'TestSuccess'/0, 'TestFailure'/0, 'NotImplemented'/0, 'ReadyRequest'/0, 'ReadyResponse'/0, 'ShutdownRequest'/0, 'ShutdownAck'/0]).

-spec encode_msg('PingPongRequest'() | 'ThroughputPingPongRequest'() | 'AtomicRegisterRequest'() | 'StreamingWindowsRequest'() | 'FibonacciRequest'() | 'ChameneosRequest'() | 'APSPRequest'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'(), atom()) -> binary().
encode_msg(Msg, MsgName) when is_atom(MsgName) ->
    encode_msg(Msg, MsgName, []).

-spec encode_msg('PingPongRequest'() | 'ThroughputPingPongRequest'() | 'AtomicRegisterRequest'() | 'StreamingWindowsRequest'() | 'FibonacciRequest'() | 'ChameneosRequest'() | 'APSPRequest'() | 'TestResult'() | 'TestSuccess'() | 'TestFailure'() | 'NotImplemented'() | 'ReadyRequest'() | 'ReadyResponse'() | 'ShutdownRequest'() | 'ShutdownAck'(), atom(), list()) -> binary().
encode_msg(Msg, MsgName, Opts) ->
    case proplists:get_bool(verify, Opts) of
      true -> verify_msg(Msg, MsgName, Opts);
      false -> ok
    ...
    case MsgName of
	  ...
	  encode_msg_StreamingWindowsRequest(id(Msg, TrUserData),
					     TrUserData);
      'FibonacciRequest' ->
	  encode_msg_FibonacciRequest(id(Msg, TrUserData),
				      TrUserData);
      'ChameneosRequest' ->
	  encode_msg_ChameneosRequest(id(Msg, TrUserData),
				      TrUserData);
      'APSPRequest' ->
	  encode_msg_APSPRequest(id(Msg, TrUserData), TrUserData);
      'TestResult' ->
	  encode_msg_TestResult(id(Msg, TrUserData), TrUserData);
      'TestSuccess' ->
	  encode_msg_TestSuccess(id(Msg, TrUserData), TrUserData);
...
encode_msg_FibonacciRequest(Msg, TrUserData) ->
    encode_msg_FibonacciRequest(Msg, <<>>, TrUserData).
...
encode_msg_ChameneosRequest(Msg, TrUserData) ->
    encode_msg_ChameneosRequest(Msg, <<>>, TrUserData).
...
encode_msg_APSPRequest(Msg, TrUserData) ->
    encode_msg_APSPRequest(Msg, <<>>, TrUserData).
...
decode_msg_2_doit('StreamingWindowsRequest', Bin,
    ...
    id(decode_msg_StreamingWindowsRequest(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('FibonacciRequest', Bin,
		  TrUserData) ->
    id(decode_msg_FibonacciRequest(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('ChameneosRequest', Bin,
		  TrUserData) ->
    id(decode_msg_ChameneosRequest(Bin, TrUserData),
       TrUserData);
decode_msg_2_doit('APSPRequest', Bin, TrUserData) ->
    id(decode_msg_APSPRequest(Bin, TrUserData), TrUserData);
decode_msg_2_doit('TestResult', Bin, TrUserData) ->
    id(decode_msg_TestResult(Bin, TrUserData), TrUserData);
decode_msg_2_doit('TestSuccess', Bin, TrUserData) ->
    id(decode_msg_TestSuccess(Bin, TrUserData), TrUserData);
...
decode_msg_FibonacciRequest(Bin, TrUserData) ->
    dfp_read_field_def_FibonacciRequest(Bin, 0, 0,
					id(0, TrUserData), TrUserData).

dfp_read_field_def_FibonacciRequest(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, TrUserData) ->
    d_field_FibonacciRequest_fib_number(Rest, Z1, Z2, F@_1,
					TrUserData);
dfp_read_field_def_FibonacciRequest(<<>>, 0, 0, F@_1,
				    _) ->
    #{fib_number => F@_1};
dfp_read_field_def_FibonacciRequest(Other, Z1, Z2, F@_1,
				    TrUserData) ->
    dg_read_field_def_FibonacciRequest(Other, Z1, Z2, F@_1,
				       TrUserData).

dg_read_field_def_FibonacciRequest(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_FibonacciRequest(Rest, N + 7,
				       X bsl N + Acc, F@_1, TrUserData);
dg_read_field_def_FibonacciRequest(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_FibonacciRequest_fib_number(Rest, 0, 0, F@_1,
					      TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_FibonacciRequest(Rest, 0, 0, F@_1,
					     TrUserData);
	    1 ->
		skip_64_FibonacciRequest(Rest, 0, 0, F@_1, TrUserData);
	    2 ->
		skip_length_delimited_FibonacciRequest(Rest, 0, 0, F@_1,
						       TrUserData);
	    3 ->
		skip_group_FibonacciRequest(Rest, Key bsr 3, 0, F@_1,
					    TrUserData);
	    5 ->
		skip_32_FibonacciRequest(Rest, 0, 0, F@_1, TrUserData)
	  end
    end;
dg_read_field_def_FibonacciRequest(<<>>, 0, 0, F@_1,
				   _) ->
    #{fib_number => F@_1}.

d_field_FibonacciRequest_fib_number(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, TrUserData)
    when N < 57 ->
    d_field_FibonacciRequest_fib_number(Rest, N + 7,
					X bsl N + Acc, F@_1, TrUserData);
d_field_FibonacciRequest_fib_number(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_FibonacciRequest(RestF, 0, 0,
					NewFValue, TrUserData).

skip_varint_FibonacciRequest(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    skip_varint_FibonacciRequest(Rest, Z1, Z2, F@_1,
				 TrUserData);
skip_varint_FibonacciRequest(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, TrUserData) ->
    dfp_read_field_def_FibonacciRequest(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_length_delimited_FibonacciRequest(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData)
    when N < 57 ->
    skip_length_delimited_FibonacciRequest(Rest, N + 7,
					   X bsl N + Acc, F@_1, TrUserData);
skip_length_delimited_FibonacciRequest(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_FibonacciRequest(Rest2, 0, 0, F@_1,
					TrUserData).

skip_group_FibonacciRequest(Bin, FNum, Z2, F@_1,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_FibonacciRequest(Rest, 0, Z2, F@_1,
					TrUserData).

skip_32_FibonacciRequest(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_FibonacciRequest(Rest, Z1, Z2, F@_1,
					TrUserData).

skip_64_FibonacciRequest(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, TrUserData) ->
    dfp_read_field_def_FibonacciRequest(Rest, Z1, Z2, F@_1,
					TrUserData).

decode_msg_ChameneosRequest(Bin, TrUserData) ->
    dfp_read_field_def_ChameneosRequest(Bin, 0, 0,
					id(0, TrUserData), id(0, TrUserData),
					TrUserData).

dfp_read_field_def_ChameneosRequest(<<8, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_ChameneosRequest_number_of_chameneos(Rest, Z1,
						 Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_ChameneosRequest(<<16, Rest/binary>>,
				    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_ChameneosRequest_number_of_meetings(Rest, Z1,
						Z2, F@_1, F@_2, TrUserData);
dfp_read_field_def_ChameneosRequest(<<>>, 0, 0, F@_1,
				    F@_2, _) ->
    #{number_of_chameneos => F@_1,
      number_of_meetings => F@_2};
dfp_read_field_def_ChameneosRequest(Other, Z1, Z2, F@_1,
				    F@_2, TrUserData) ->
    dg_read_field_def_ChameneosRequest(Other, Z1, Z2, F@_1,
				       F@_2, TrUserData).

dg_read_field_def_ChameneosRequest(<<1:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_ChameneosRequest(Rest, N + 7,
				       X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_ChameneosRequest(<<0:1, X:7,
				     Rest/binary>>,
				   N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_ChameneosRequest_number_of_chameneos(Rest, 0, 0,
						       F@_1, F@_2, TrUserData);
      16 ->
	  d_field_ChameneosRequest_number_of_meetings(Rest, 0, 0,
						      F@_1, F@_2, TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_ChameneosRequest(Rest, 0, 0, F@_1, F@_2,
					     TrUserData);
	    1 ->
		skip_64_ChameneosRequest(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
	    2 ->
		skip_length_delimited_ChameneosRequest(Rest, 0, 0, F@_1,
						       F@_2, TrUserData);
	    3 ->
		skip_group_ChameneosRequest(Rest, Key bsr 3, 0, F@_1,
					    F@_2, TrUserData);
	    5 ->
		skip_32_ChameneosRequest(Rest, 0, 0, F@_1, F@_2,
					 TrUserData)
	  end
    end;
dg_read_field_def_ChameneosRequest(<<>>, 0, 0, F@_1,
				   F@_2, _) ->
    #{number_of_chameneos => F@_1,
      number_of_meetings => F@_2}.

d_field_ChameneosRequest_number_of_chameneos(<<1:1, X:7,
					       Rest/binary>>,
					     N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_ChameneosRequest_number_of_chameneos(Rest,
						 N + 7, X bsl N + Acc, F@_1,
						 F@_2, TrUserData);
d_field_ChameneosRequest_number_of_chameneos(<<0:1, X:7,
					       Rest/binary>>,
					     N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_ChameneosRequest(RestF, 0, 0,
					NewFValue, F@_2, TrUserData).

d_field_ChameneosRequest_number_of_meetings(<<1:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_ChameneosRequest_number_of_meetings(Rest, N + 7,
						X bsl N + Acc, F@_1, F@_2,
						TrUserData);
d_field_ChameneosRequest_number_of_meetings(<<0:1, X:7,
					      Rest/binary>>,
					    N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_ChameneosRequest(RestF, 0, 0, F@_1,
					NewFValue, TrUserData).

skip_varint_ChameneosRequest(<<1:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_ChameneosRequest(Rest, Z1, Z2, F@_1, F@_2,
				 TrUserData);
skip_varint_ChameneosRequest(<<0:1, _:7, Rest/binary>>,
			     Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ChameneosRequest(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_length_delimited_ChameneosRequest(<<1:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_ChameneosRequest(Rest, N + 7,
					   X bsl N + Acc, F@_1, F@_2,
					   TrUserData);
skip_length_delimited_ChameneosRequest(<<0:1, X:7,
					 Rest/binary>>,
				       N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_ChameneosRequest(Rest2, 0, 0, F@_1,
					F@_2, TrUserData).

skip_group_ChameneosRequest(Bin, FNum, Z2, F@_1, F@_2,
			    TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_ChameneosRequest(Rest, 0, Z2, F@_1,
					F@_2, TrUserData).

skip_32_ChameneosRequest(<<_:32, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ChameneosRequest(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

skip_64_ChameneosRequest(<<_:64, Rest/binary>>, Z1, Z2,
			 F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ChameneosRequest(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData).

decode_msg_APSPRequest(Bin, TrUserData) ->
    dfp_read_field_def_APSPRequest(Bin, 0, 0,
				   id(0, TrUserData), id(0, TrUserData),
				   TrUserData).

dfp_read_field_def_APSPRequest(<<8, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_field_APSPRequest_number_of_nodes(Rest, Z1, Z2, F@_1,
					F@_2, TrUserData);
dfp_read_field_def_APSPRequest(<<16, Rest/binary>>, Z1,
			       Z2, F@_1, F@_2, TrUserData) ->
    d_field_APSPRequest_block_size(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData);
dfp_read_field_def_APSPRequest(<<>>, 0, 0, F@_1, F@_2,
			       _) ->
    #{number_of_nodes => F@_1, block_size => F@_2};
dfp_read_field_def_APSPRequest(Other, Z1, Z2, F@_1,
			       F@_2, TrUserData) ->
    dg_read_field_def_APSPRequest(Other, Z1, Z2, F@_1, F@_2,
				  TrUserData).

dg_read_field_def_APSPRequest(<<1:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_APSPRequest(Rest, N + 7,
				  X bsl N + Acc, F@_1, F@_2, TrUserData);
dg_read_field_def_APSPRequest(<<0:1, X:7, Rest/binary>>,
			      N, Acc, F@_1, F@_2, TrUserData) ->
    Key = X bsl N + Acc,
    case Key of
      8 ->
	  d_field_APSPRequest_number_of_nodes(Rest, 0, 0, F@_1,
					      F@_2, TrUserData);
      16 ->
	  d_field_APSPRequest_block_size(Rest, 0, 0, F@_1, F@_2,
					 TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_APSPRequest(Rest, 0, 0, F@_1, F@_2,
					TrUserData);
	    1 ->
		skip_64_APSPRequest(Rest, 0, 0, F@_1, F@_2, TrUserData);
	    2 ->
		skip_length_delimited_APSPRequest(Rest, 0, 0, F@_1,
						  F@_2, TrUserData);
	    3 ->
		skip_group_APSPRequest(Rest, Key bsr 3, 0, F@_1, F@_2,
				       TrUserData);
	    5 ->
		skip_32_APSPRequest(Rest, 0, 0, F@_1, F@_2, TrUserData)
	  end
    end;
dg_read_field_def_APSPRequest(<<>>, 0, 0, F@_1, F@_2,
			      _) ->
    #{number_of_nodes => F@_1, block_size => F@_2}.

d_field_APSPRequest_number_of_nodes(<<1:1, X:7,
				      Rest/binary>>,
				    N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_APSPRequest_number_of_nodes(Rest, N + 7,
					X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_APSPRequest_number_of_nodes(<<0:1, X:7,
				      Rest/binary>>,
				    N, Acc, _, F@_2, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_APSPRequest(RestF, 0, 0, NewFValue,
				   F@_2, TrUserData).

d_field_APSPRequest_block_size(<<1:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    d_field_APSPRequest_block_size(Rest, N + 7,
				   X bsl N + Acc, F@_1, F@_2, TrUserData);
d_field_APSPRequest_block_size(<<0:1, X:7,
				 Rest/binary>>,
			       N, Acc, F@_1, _, TrUserData) ->
    {NewFValue, RestF} = {id(X bsl N + Acc, TrUserData),
			  Rest},
    dfp_read_field_def_APSPRequest(RestF, 0, 0, F@_1,
				   NewFValue, TrUserData).

skip_varint_APSPRequest(<<1:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, TrUserData) ->
    skip_varint_APSPRequest(Rest, Z1, Z2, F@_1, F@_2,
			    TrUserData);
skip_varint_APSPRequest(<<0:1, _:7, Rest/binary>>, Z1,
			Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_APSPRequest(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData).

skip_length_delimited_APSPRequest(<<1:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData)
    when N < 57 ->
    skip_length_delimited_APSPRequest(Rest, N + 7,
				      X bsl N + Acc, F@_1, F@_2, TrUserData);
skip_length_delimited_APSPRequest(<<0:1, X:7,
				    Rest/binary>>,
				  N, Acc, F@_1, F@_2, TrUserData) ->
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_APSPRequest(Rest2, 0, 0, F@_1, F@_2,
				   TrUserData).

skip_group_APSPRequest(Bin, FNum, Z2, F@_1, F@_2,
		       TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_APSPRequest(Rest, 0, Z2, F@_1, F@_2,
				   TrUserData).

skip_32_APSPRequest(<<_:32, Rest/binary>>, Z1, Z2, F@_1,
		    F@_2, TrUserData) ->
    dfp_read_field_def_APSPRequest(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData).

skip_64_APSPRequest(<<_:64, Rest/binary>>, Z1, Z2, F@_1,
		    F@_2, TrUserData) ->
    dfp_read_field_def_APSPRequest(Rest, Z1, Z2, F@_1, F@_2,
				   TrUserData).
...
merge_msgs(Prev, New, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  merge_msg_StreamingWindowsRequest(Prev, New,
					    TrUserData);
      'FibonacciRequest' ->
	  merge_msg_FibonacciRequest(Prev, New, TrUserData);
      'ChameneosRequest' ->
	  merge_msg_ChameneosRequest(Prev, New, TrUserData);
      'APSPRequest' ->
	  merge_msg_APSPRequest(Prev, New, TrUserData);
      'TestResult' ->
	  merge_msg_TestResult(Prev, New, TrUserData);
      'TestSuccess' ->
	  merge_msg_TestSuccess(Prev, New, TrUserData);
...
merge_msg_FibonacciRequest(PMsg, NMsg, _) ->
    S1 = #{},
    case {PMsg, NMsg} of
      {_, #{fib_number := NFfib_number}} ->
	  S1#{fib_number => NFfib_number};
      {#{fib_number := PFfib_number}, _} ->
	  S1#{fib_number => PFfib_number};
      _ -> S1
    end.
...
merge_msg_ChameneosRequest(PMsg, NMsg, _) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {_, #{number_of_chameneos := NFnumber_of_chameneos}} ->
	       S1#{number_of_chameneos => NFnumber_of_chameneos};
	   {#{number_of_chameneos := PFnumber_of_chameneos}, _} ->
	       S1#{number_of_chameneos => PFnumber_of_chameneos};
	   _ -> S1
	 end,
    case {PMsg, NMsg} of
      {_, #{number_of_meetings := NFnumber_of_meetings}} ->
	  S2#{number_of_meetings => NFnumber_of_meetings};
      {#{number_of_meetings := PFnumber_of_meetings}, _} ->
	  S2#{number_of_meetings => PFnumber_of_meetings};
      _ -> S2
    end.
...
merge_msg_APSPRequest(PMsg, NMsg, _) ->
    S1 = #{},
    S2 = case {PMsg, NMsg} of
	   {_, #{number_of_nodes := NFnumber_of_nodes}} ->
	       S1#{number_of_nodes => NFnumber_of_nodes};
	   {#{number_of_nodes := PFnumber_of_nodes}, _} ->
	       S1#{number_of_nodes => PFnumber_of_nodes};
	   _ -> S1
	 end,
    case {PMsg, NMsg} of
      {_, #{block_size := NFblock_size}} ->
	  S2#{block_size => NFblock_size};
      {#{block_size := PFblock_size}, _} ->
	  S2#{block_size => PFblock_size};
      _ -> S2
    end.
...
verify_msg(Msg, MsgName, Opts) ->
    ...
    case MsgName of
	  ...
	  v_msg_StreamingWindowsRequest(Msg, [MsgName],
					TrUserData);
      'FibonacciRequest' ->
	  v_msg_FibonacciRequest(Msg, [MsgName], TrUserData);
      'ChameneosRequest' ->
	  v_msg_ChameneosRequest(Msg, [MsgName], TrUserData);
      'APSPRequest' ->
	  v_msg_APSPRequest(Msg, [MsgName], TrUserData);
      'TestResult' ->
	  v_msg_TestResult(Msg, [MsgName], TrUserData);
      'TestSuccess' ->
	  v_msg_TestSuccess(Msg, [MsgName], TrUserData);
...
v_msg_FibonacciRequest(#{} = M, Path, TrUserData) ->
    case M of
      #{fib_number := F1} ->
	  v_type_uint32(F1, [fib_number | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (fib_number) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_FibonacciRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'FibonacciRequest'},
		  M, Path);
v_msg_FibonacciRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'FibonacciRequest'}, X,
		  Path).
...
v_msg_ChameneosRequest(#{} = M, Path, TrUserData) ->
    case M of
      #{number_of_chameneos := F1} ->
	  v_type_uint32(F1, [number_of_chameneos | Path],
			TrUserData);
      _ -> ok
    end,
    case M of
      #{number_of_meetings := F2} ->
	  v_type_uint64(F2, [number_of_meetings | Path],
			TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (number_of_chameneos) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_ChameneosRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'ChameneosRequest'},
		  M, Path);
v_msg_ChameneosRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'ChameneosRequest'}, X,
		  Path).
...
v_msg_APSPRequest(#{} = M, Path, TrUserData) ->
    case M of
      #{number_of_nodes := F1} ->
	  v_type_uint32(F1, [number_of_nodes | Path], TrUserData);
      _ -> ok
    end,
    case M of
      #{block_size := F2} ->
	  v_type_uint32(F2, [block_size | Path], TrUserData);
      _ -> ok
    end,
    lists:foreach(fun (number_of_nodes) -> ok;
		  ...
		  maps:keys(M)),
    ok;
v_msg_APSPRequest(M, Path, _TrUserData)
    when is_map(M) ->
    mk_type_error({missing_fields, [] -- maps:keys(M),
		   'APSPRequest'},
		  M, Path);
v_msg_APSPRequest(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'APSPRequest'}, X, Path).
...
get_msg_defs() ->
    [{{msg, 'PingPongRequest'},
	 ...
	 rnum => 6, type => uint64, occurrence => optional,
	 opts => []}]},
     {{msg, 'FibonacciRequest'},
      [#{name => fib_number, fnum => 1, rnum => 2,
	 type => uint32, occurrence => optional, opts => []}]},
     {{msg, 'ChameneosRequest'},
      [#{name => number_of_chameneos, fnum => 1, rnum => 2,
	 type => uint32, occurrence => optional, opts => []},
       #{name => number_of_meetings, fnum => 2, rnum => 3,
	 type => uint64, occurrence => optional, opts => []}]},
     {{msg, 'APSPRequest'},
      [#{name => number_of_nodes, fnum => 1, rnum => 2,
	 type => uint32, occurrence => optional, opts => []},
       #{name => block_size, fnum => 2, rnum => 3,
	 type => uint32, occurrence => optional, opts => []}]},
     {{msg, 'TestResult'},
      [#{name => sealed_value, rnum => 2,
	 fields =>
...
get_msg_names() ->
    ['PingPongRequest', 'ThroughputPingPongRequest',
     'AtomicRegisterRequest', 'StreamingWindowsRequest',
     'FibonacciRequest', 'ChameneosRequest', 'APSPRequest',
     'TestResult', 'TestSuccess', 'TestFailure',
     'NotImplemented', 'ReadyRequest', 'ReadyResponse',
     'ShutdownRequest', 'ShutdownAck'].
...
find_msg_def('StreamingWindowsRequest') ->
    [#{name => number_of_partitions, fnum => 1, rnum => 2,
     ...
     #{name => window_size_amplification, fnum => 5,
       rnum => 6, type => uint64, occurrence => optional,
       opts => []}];
find_msg_def('FibonacciRequest') ->
    [#{name => fib_number, fnum => 1, rnum => 2,
       type => uint32, occurrence => optional, opts => []}];
find_msg_def('ChameneosRequest') ->
    [#{name => number_of_chameneos, fnum => 1, rnum => 2,
       type => uint32, occurrence => optional, opts => []},
     #{name => number_of_meetings, fnum => 2, rnum => 3,
       type => uint64, occurrence => optional, opts => []}];
find_msg_def('APSPRequest') ->
    [#{name => number_of_nodes, fnum => 1, rnum => 2,
       type => uint32, occurrence => optional, opts => []},
     #{name => block_size, fnum => 2, rnum => 3,
       type => uint32, occurrence => optional, opts => []}];
...
get_service_def('BenchmarkRunner') ->
	...
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'Fibonacci', input => 'FibonacciRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'Chameneos', input => 'ChameneosRequest',
	output => 'TestResult', input_stream => false,
	output_stream => false, opts => []},
      #{name => 'AllPairsShortestPath',
	input => 'APSPRequest', output => 'TestResult',
...
get_rpc_names('BenchmarkRunner') ->
    ['Ready', 'Shutdown', 'PingPong', 'NetPingPong',
     'ThroughputPingPong', 'NetThroughputPingPong',
     'AtomicRegister', 'StreamingWindows', 'Fibonacci',
     'Chameneos', 'AllPairsShortestPath'];
get_rpc_names(_) -> error.
...
find_rpc_def_BenchmarkRunner('StreamingWindows') ->
    #{name => 'StreamingWindows',
      ...
      output => 'TestResult', input_stream => false,
      output_stream => false, opts => []};
find_rpc_def_BenchmarkRunner('Fibonacci') ->
    #{name => 'Fibonacci', input => 'FibonacciRequest',
      output => 'TestResult', input_stream => false,
      output_stream => false, opts => []};
find_rpc_def_BenchmarkRunner('Chameneos') ->
    #{name => 'Chameneos', input => 'ChameneosRequest',
      output => 'TestResult', input_stream => false,
      output_stream => false, opts => []};
find_rpc_def_BenchmarkRunner('AllPairsShortestPath') ->
    #{name => 'AllPairsShortestPath',
      input => 'APSPRequest', output => 'TestResult',
      input_stream => false, output_stream => false,
      opts => []};
...
fqbins_to_service_and_rpc_name(<<"kompics.benchmarks.BenchmarkRunner">>, <<"StreamingWindows">>) ->
    {'BenchmarkRunner', 'StreamingWindows'};
fqbins_to_service_and_rpc_name(<<"kompics.benchmarks.BenchmarkRunner">>, <<"Fibonacci">>) ->
    {'BenchmarkRunner', 'Fibonacci'};
fqbins_to_service_and_rpc_name(<<"kompics.benchmarks.BenchmarkRunner">>, <<"Chameneos">>) ->
    {'BenchmarkRunner', 'Chameneos'};
fqbins_to_service_and_rpc_name(<<"kompics.benchmarks.BenchmarkRunner">>, <<"AllPairsShortestPath">>) ->
...
service_and_rpc_name_to_fqbins('BenchmarkRunner',
			       'Fibonacci') ->
    {<<"kompics.benchmarks.BenchmarkRunner">>, <<"Fibonacci">>};
service_and_rpc_name_to_fqbins('BenchmarkRunner',
			       'Chameneos') ->
    {<<"kompics.benchmarks.BenchmarkRunner">>, <<"Chameneos">>};
service_and_rpc_name_to_fqbins('BenchmarkRunner',
			       'AllPairsShortestPath') ->
    {<<"kompics.benchmarks.BenchmarkRunner">>, <<"AllPairsShortestPath">>};
service_and_rpc_name_to_fqbins(S, R) ->
    error({gpb_error, {badservice_or_rpc, {S, R}}}).
...
get_msg_containment("benchmarks") ->
    ['APSPRequest', 'AtomicRegisterRequest',
     'ChameneosRequest', 'FibonacciRequest',
     'PingPongRequest', 'StreamingWindowsRequest',
     'ThroughputPingPongRequest'];
get_msg_containment("messages") ->
    ['NotImplemented', 'ReadyRequest', 'ReadyResponse',
     'ShutdownAck', 'ShutdownRequest', 'TestFailure',
