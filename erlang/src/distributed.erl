...
decode_msg_ClientInfo(Bin, TrUserData) ->
    dfp_read_field_def_ClientInfo(Bin,
                                  0,
                                  0,
                                  id([], TrUserData),
                                  id(0, TrUserData),
...
dfp_read_field_def_ClientInfo(<<10, Rest/binary>>, Z1,
    ...
    d_field_ClientInfo_address(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
dfp_read_field_def_ClientInfo(Other, Z1, Z2, F@_1, F@_2,
                              TrUserData) ->
    dg_read_field_def_ClientInfo(Other,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dg_read_field_def_ClientInfo(<<1:1, X:7, Rest/binary>>,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_ClientInfo(Rest,
                                 N + 7,
                                 X bsl N + Acc,
                                 F@_1,
                                 F@_2,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_ClientInfo(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
...
d_field_ClientInfo_address(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_ClientInfo(RestF,
                                  0,
                                  0,
                                  NewFValue,
                                  F@_2,
...
skip_varint_ClientInfo(<<0:1, _:7, Rest/binary>>, Z1,
                       Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_ClientInfo(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
skip_length_delimited_ClientInfo(<<0:1, X:7,
    ...
    dfp_read_field_def_ClientInfo(Rest2,
                                  0,
                                  0,
                                  F@_1,
                                  F@_2,
...
decode_msg_CheckinResponse(Bin, TrUserData) ->
    dfp_read_field_def_CheckinResponse(Bin,
                                       0,
                                       0,
                                       TrUserData).
...
dfp_read_field_def_CheckinResponse(Other, Z1, Z2,
                                   TrUserData) ->
    dg_read_field_def_CheckinResponse(Other,
                                      Z1,
                                      Z2,
                                      TrUserData).
...
dg_read_field_def_CheckinResponse(<<1:1, X:7,
                                  ...
                                  N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_CheckinResponse(Rest,
                                      N + 7,
                                      X bsl N + Acc,
                                      TrUserData);
dg_read_field_def_CheckinResponse(<<0:1, X:7,
    ...
    case Key band 7 of
        ...
        2 ->
            skip_length_delimited_CheckinResponse(Rest,
                                                  0,
                                                  0,
                                                  TrUserData);
        3 ->
            skip_group_CheckinResponse(Rest,
                                       Key bsr 3,
                                       0,
                                       TrUserData);
...
skip_varint_CheckinResponse(<<0:1, _:7, Rest/binary>>,
                            Z1, Z2, TrUserData) ->
    dfp_read_field_def_CheckinResponse(Rest,
                                       Z1,
                                       Z2,
                                       TrUserData).
...
skip_length_delimited_CheckinResponse(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_CheckinResponse(Rest2,
                                       0,
                                       0,
                                       TrUserData).
...
decode_msg_SetupConfig(Bin, TrUserData) ->
    dfp_read_field_def_SetupConfig(Bin,
                                   0,
                                   0,
                                   id([], TrUserData),
                                   id([], TrUserData),
...
dfp_read_field_def_SetupConfig(<<10, Rest/binary>>, Z1,
                               Z2, F@_1, F@_2, TrUserData) ->
    d_field_SetupConfig_label(Rest,
                              Z1,
                              Z2,
                              F@_1,
                              F@_2,
...
dfp_read_field_def_SetupConfig(Other, Z1, Z2, F@_1,
                               F@_2, TrUserData) ->
    dg_read_field_def_SetupConfig(Other,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
dg_read_field_def_SetupConfig(<<1:1, X:7, Rest/binary>>,
                              N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_SetupConfig(Rest,
                                  N + 7,
                                  X bsl N + Acc,
                                  F@_1,
                                  F@_2,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_SetupConfig(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      F@_2,
...
d_field_SetupConfig_label(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_SetupConfig(RestF,
                                   0,
                                   0,
                                   NewFValue,
                                   F@_2,
...
skip_varint_SetupConfig(<<0:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_SetupConfig(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
...
skip_length_delimited_SetupConfig(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_SetupConfig(Rest2,
                                   0,
                                   0,
                                   F@_1,
                                   F@_2,
...
decode_msg_SetupResponse(Bin, TrUserData) ->
    dfp_read_field_def_SetupResponse(Bin,
                                     0,
                                     0,
                                     id(false, TrUserData),
                                     id([], TrUserData),
...
dfp_read_field_def_SetupResponse(<<8, Rest/binary>>, Z1,
                                 Z2, F@_1, F@_2, TrUserData) ->
    d_field_SetupResponse_success(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
dfp_read_field_def_SetupResponse(<<18, Rest/binary>>,
    ...
    d_field_SetupResponse_data(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
dfp_read_field_def_SetupResponse(Other, Z1, Z2, F@_1,
                                 F@_2, TrUserData) ->
    dg_read_field_def_SetupResponse(Other,
                                    Z1,
                                    Z2,
                                    F@_1,
                                    F@_2,
...
dg_read_field_def_SetupResponse(<<1:1, X:7,
                                ...
                                N, Acc, F@_1, F@_2, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_SetupResponse(Rest,
                                    N + 7,
                                    X bsl N + Acc,
                                    F@_1,
                                    F@_2,
...
dg_read_field_def_SetupResponse(<<0:1, X:7,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_SetupResponse(Rest,
                                              0,
                                              0,
                                              F@_1,
                                              F@_2,
                ...
                1 ->
                    skip_64_SetupResponse(Rest,
                                          ...
                                          TrUserData);
                2 ->
                    skip_length_delimited_SetupResponse(Rest,
                                                        0,
                                                        0,
                                                        F@_1,
                                                        F@_2,
...
d_field_SetupResponse_success(<<0:1, X:7, Rest/binary>>,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
                             TrUserData),
                          Rest},
    dfp_read_field_def_SetupResponse(RestF,
                                     0,
                                     0,
                                     NewFValue,
                                     F@_2,
...
skip_varint_SetupResponse(<<0:1, _:7, Rest/binary>>, Z1,
                          Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_SetupResponse(Rest,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
...
skip_length_delimited_SetupResponse(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_SetupResponse(Rest2,
                                     0,
                                     0,
                                     F@_1,
                                     F@_2,
...
decode_msg_CleanupInfo(Bin, TrUserData) ->
    dfp_read_field_def_CleanupInfo(Bin,
                                   0,
                                   0,
                                   id(false, TrUserData),
                                   TrUserData).
...
dfp_read_field_def_CleanupInfo(<<8, Rest/binary>>, Z1,
                               Z2, F@_1, TrUserData) ->
    d_field_CleanupInfo_final(Rest,
                              Z1,
                              Z2,
                              F@_1,
                              TrUserData);
...
dfp_read_field_def_CleanupInfo(Other, Z1, Z2, F@_1,
                               TrUserData) ->
    dg_read_field_def_CleanupInfo(Other,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  TrUserData).
...
dg_read_field_def_CleanupInfo(<<1:1, X:7, Rest/binary>>,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_CleanupInfo(Rest,
                                  N + 7,
                                  X bsl N + Acc,
                                  F@_1,
                                  TrUserData);
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_CleanupInfo(Rest,
                                                      0,
                                                      0,
                                                      F@_1,
                                                      TrUserData);
                3 ->
                    skip_group_CleanupInfo(Rest,
                                           Key bsr 3,
                                           0,
                                           F@_1,
                                           TrUserData);
...
d_field_CleanupInfo_final(<<0:1, X:7, Rest/binary>>, N,
    ...
    {NewFValue, RestF} = {id(X bsl N + Acc =/= 0,
                             TrUserData),
                          Rest},
    dfp_read_field_def_CleanupInfo(RestF,
                                   0,
                                   0,
                                   NewFValue,
                                   TrUserData).
...
skip_varint_CleanupInfo(<<0:1, _:7, Rest/binary>>, Z1,
                        Z2, F@_1, TrUserData) ->
    dfp_read_field_def_CleanupInfo(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   TrUserData).
...
skip_length_delimited_CleanupInfo(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_CleanupInfo(Rest2,
                                   0,
                                   0,
                                   F@_1,
                                   TrUserData).
...
decode_msg_CleanupResponse(Bin, TrUserData) ->
    dfp_read_field_def_CleanupResponse(Bin,
                                       0,
                                       0,
                                       TrUserData).
...
dfp_read_field_def_CleanupResponse(Other, Z1, Z2,
                                   TrUserData) ->
    dg_read_field_def_CleanupResponse(Other,
                                      Z1,
                                      Z2,
                                      TrUserData).
...
dg_read_field_def_CleanupResponse(<<1:1, X:7,
                                  ...
                                  N, Acc, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_CleanupResponse(Rest,
                                      N + 7,
                                      X bsl N + Acc,
                                      TrUserData);
dg_read_field_def_CleanupResponse(<<0:1, X:7,
    ...
    case Key band 7 of
        ...
        2 ->
            skip_length_delimited_CleanupResponse(Rest,
                                                  0,
                                                  0,
                                                  TrUserData);
        3 ->
            skip_group_CleanupResponse(Rest,
                                       Key bsr 3,
                                       0,
                                       TrUserData);
...
skip_varint_CleanupResponse(<<0:1, _:7, Rest/binary>>,
                            Z1, Z2, TrUserData) ->
    dfp_read_field_def_CleanupResponse(Rest,
                                       Z1,
                                       Z2,
                                       TrUserData).
...
skip_length_delimited_CleanupResponse(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_CleanupResponse(Rest2,
                                       0,
                                       0,
                                       TrUserData).
...
v_msg_CheckinResponse(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'CheckinResponse'},
                  X,
                  Path).
...
v_msg_CleanupResponse(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'CleanupResponse'},
                  X,
                  Path).
