...
encode_msg_ClientInfo(#'ClientInfo'{address = F1,
				    port = F2},
		      Bin, TrUserData) ->
...
encode_msg_SetupConfig(#'SetupConfig'{label = F1,
				      data = F2},
		       Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
	    true ->
...
encode_msg_SetupResponse(#'SetupResponse'{success = F1,
					  data = F2},
			 Bin, TrUserData) ->
    B1 = if F1 == undefined -> Bin;
	    true ->
...
encode_msg_CleanupInfo(#'CleanupInfo'{final = F1}, Bin,
		       TrUserData) ->
    if F1 == undefined -> Bin;
       true ->
	   begin
...
dfp_read_field_def_ClientInfo(<<>>, 0, 0, F@_1, F@_2,
			      _) ->
    #'ClientInfo'{address = F@_1, port = F@_2};
...
dfp_read_field_def_SetupConfig(<<>>, 0, 0, F@_1, F@_2,
			       _) ->
    #'SetupConfig'{label = F@_1, data = F@_2};
...
dfp_read_field_def_SetupResponse(<<>>, 0, 0, F@_1, F@_2,
				 _) ->
    #'SetupResponse'{success = F@_1, data = F@_2};
...
merge_msg_ClientInfo(#'ClientInfo'{address = PFaddress,
				   port = PFport},
		     #'ClientInfo'{address = NFaddress, port = NFport}, _) ->
    #'ClientInfo'{address =
...
merge_msg_SetupConfig(#'SetupConfig'{label = PFlabel,
				     data = PFdata},
		      #'SetupConfig'{label = NFlabel, data = NFdata}, _) ->
    #'SetupConfig'{label =
...
merge_msg_SetupResponse(#'SetupResponse'{success =
					     PFsuccess,
					 data = PFdata},
			#'SetupResponse'{success = NFsuccess, data = NFdata},
			_) ->
...
merge_msg_CleanupInfo(#'CleanupInfo'{final = PFfinal},
		      #'CleanupInfo'{final = NFfinal}, _) ->
    #'CleanupInfo'{final =
...
v_msg_ClientInfo(#'ClientInfo'{address = F1, port = F2},
		 Path, TrUserData) ->
    if F1 == undefined -> ok;
...
v_msg_CheckinResponse(#'CheckinResponse'{}, _Path, _) ->
    ok;
...
v_msg_SetupConfig(#'SetupConfig'{label = F1, data = F2},
		  Path, TrUserData) ->
    if F1 == undefined -> ok;
...
v_msg_SetupResponse(#'SetupResponse'{success = F1,
				     data = F2},
		    Path, TrUserData) ->
    if F1 == undefined -> ok;
...
v_msg_CleanupInfo(#'CleanupInfo'{final = F1}, Path,
		  TrUserData) ->
    if F1 == undefined -> ok;
...
v_msg_CleanupResponse(#'CleanupResponse'{}, _Path, _) ->
    ok;
...
get_msg_defs() ->
    [{{msg, 'ClientInfo'},
      [#field{name = address, fnum = 1, rnum = 2,
	      type = string, occurrence = optional, opts = []},
       #field{name = port, fnum = 2, rnum = 3, type = uint32,
	      occurrence = optional, opts = []}]},
     {{msg, 'CheckinResponse'}, []},
     {{msg, 'SetupConfig'},
      [#field{name = label, fnum = 1, rnum = 2, type = string,
	      occurrence = optional, opts = []},
       #field{name = data, fnum = 2, rnum = 3, type = string,
	      occurrence = optional, opts = []}]},
     {{msg, 'SetupResponse'},
      [#field{name = success, fnum = 1, rnum = 2, type = bool,
       ...
       #field{name = data, fnum = 2, rnum = 3, type = string,
	      occurrence = optional, opts = []}]},
     {{msg, 'CleanupInfo'},
      [#field{name = final, fnum = 1, rnum = 2, type = bool,
	      occurrence = optional, opts = []}]},
     {{msg, 'CleanupResponse'}, []},
     {{msg, 'TestResult'},
